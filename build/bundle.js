...
var app = (function () {
    ...
    /* src/components/Topic.svelte generated by Svelte v3.42.6 */

    const file$2 = "src/components/Topic.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$2, 17, 4, 258);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let div0;
    	let button;
    	let if_block = /*topic*/ ctx[0].desc && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$2, 5, 2, 81);
    			add_location(td0, file$2, 8, 6, 129);
    			add_location(td1, file$2, 9, 6, 153);
    			add_location(tr0, file$2, 7, 4, 118);
    			add_location(td2, file$2, 12, 6, 185);
    			add_location(td3, file$2, 13, 6, 207);
    			add_location(tr1, file$2, 11, 4, 174);
    			add_location(table, file$2, 6, 2, 106);
    			attr_dev(button, "class", "button");
    			add_location(button, file$2, 20, 4, 314);
    			attr_dev(div0, "class", "buttons");
    			add_location(div0, file$2, 19, 2, 288);
    			attr_dev(div1, "class", "card card-shadow content");
    			add_location(div1, file$2, 4, 0, 40);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Topic extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { topic: 0 });
    ...
    const file$1 = "src/components/TopicList.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const topic_changes = {};
    			if (dirty & /*$TopicStore*/ 1) topic_changes.topic = /*topic*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:2) {#each $TopicStore as topic}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	let div;
    	let current;
    	let each_value = /*$TopicStore*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "pool-list-body");
    			add_location(div, file$1, 8, 0, 176);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$TopicStore*/ 1) {
    				each_value = /*$TopicStore*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $TopicStore;
    	validate_store(TopicStore, 'TopicStore');
    	component_subscribe($$self, TopicStore, $$value => $$invalidate(0, $TopicStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ onMount, TopicStore, Topic, $TopicStore });
    	return [$TopicStore];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file, 6, 0, 179);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, t0);
    			append_dev(div1, div0);
    			mount_component(topiclist, div0, null);
    			append_dev(div1, t1);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Footer, TopicList });
    	return [];
    }
